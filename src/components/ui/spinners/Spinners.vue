<template>
  <div class="row spinners">
    <div class="col-md-12">
      <vuestic-widget :header-text="$t('spinners.title')" class="spinners__widget">
        <div class="spinners__customization">
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4 spinners__color">
              <vuestic-pallet-custom v-model="color" :palette="paletteArray" class="spinners__color-picker" />
            </div>
          </div>
          <div class="row">
          ...
          <div v-for="item in group" :key="item" class="col-sm-12 col-md-3">
            <div class="spinner-box-container">
              <div class="spinner-box">
                <component :is="item" :animation-duration="speed" :color="color" :size="config.size"> </component>
              </div>
...
import VuesticSlider from '../../../vuestic-theme/vuestic-components/vuestic-slider/VuesticSlider';
import VuesticIconFaster from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconFaster';
import VuesticIconSlower from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconSlower';
