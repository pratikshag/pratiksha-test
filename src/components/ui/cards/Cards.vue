  ...
  <div class="row">
    <div class="col-md-12">
      <div class="cards-container">
        ...
        <template v-for="loop in listLoops">
          <vuestic-card :key="loop" title-on-image overlay image="https://picsum.photos/300/200/?image=1043">
            <template slot="title">
          ...
          <vuestic-card image="https://picsum.photos/300/200/?image=898">
            <template slot="title">
          ...
          <vuestic-card image="https://picsum.photos/300/200/?image=1052" title-on-image overlay>
            <template slot="title">
          ...
          <vuestic-card image="https://picsum.photos/300/200/?image=1067">
            Short one
            <p class="mb-0 mt-2">
              <a href="#" class="pr-2">{{ $t('cards.link.action1') }}</a>
              <a class="card-link-secondary" href="#"> {{ $t('cards.link.action2') }}</a>
            </p>
          </vuestic-card>

          <vuestic-card stripe="warning" image="https://picsum.photos/300/200/?image=1058">
            <p class="mb-0">
          ...
          <vuestic-card image="https://picsum.photos/300/200/?image=997">
            {{ $t('cards.contentText') }}
            <p class="pt-3 mb-0">
          ...
          <vuestic-card image="https://picsum.photos/300/200/?image=1013" theme="dark">
          ...
          <vuestic-card image="https://picsum.photos/300/200/?image=885">
            <div class="d-flex">
          ...
          <vuestic-card image="https://picsum.photos/300/200/?image=1003">
            <p>{{ $t('cards.contentText') }}</p>
    ...
    <div class="col-md-12 d-flex align-items-center justify-content-center">
      <div class="pre-loader-container">
        ...
        <div v-if="!isShown">
          <button class="btn btn-primary" @click="addCards()">Show More</button>
        </div>
      </div>
    </div>
  </div>
