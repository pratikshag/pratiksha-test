<template>
  <div class="notifications-page">
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget :header-text="'notificationsPage.popovers.title' | translate">
          <div class="row">
            <div class="col-md-6">
              <fieldset>
                <div class="form-group">
                  <div class="input-group">
                    <input id="popover-title" v-model="popoverTitle" required @input="checkPopoverContents" />
                    <label class="control-label" for="popover-title">{{
                      'notificationsPage.popovers.popoverTitleLabel' | translate
                    }}</label
                    ><i class="bar"></i>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    <input id="popover-text" v-model="popoverText" required @input="checkPopoverContents" />
                    <label class="control-label" for="popover-text">{{
                      'notificationsPage.popovers.popoverTextLabel' | translate
                    }}</label
                    ><i class="bar"></i>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    <input id="popover-icon" v-model="popoverIcon" required @input="checkPopoverContents" />
                    <label class="control-label" for="popover-icon">{{
                      'notificationsPage.popovers.popoverIconLabel' | translate
                    }}</label
                    ><i class="bar"></i>
                  </div>
                </div>
                <vuestic-popover popover-class="vuestic-tooltip" placement="right" :disabled="isPopoverDisabled">
                  ...
                  <i slot="icon" class="fa" :class="popoverIcon"> </i>
            ...
            <div class="col-md-6">
              <p>
                ...
                <vuestic-tooltip :options="topTooltipOptions"
                  ><a href="#">{{ 'notificationsPage.popovers.topTooltip' | translate }}</a></vuestic-tooltip
                >
                showcase. Just anything you can possibly imagine to test
                <vuestic-tooltip :options="rightTooltipOptions"
                  ><a href="#">{{ 'notificationsPage.popovers.rightTooltip' | translate }}</a></vuestic-tooltip
                >. But it can appear on the
                <vuestic-tooltip :options="leftTooltipOptions"
                  ><a href="#">{{ 'notificationsPage.popovers.leftTooltip' | translate }}</a></vuestic-tooltip
                >. Or just
                <vuestic-tooltip :options="bottomTooltipOptions"
                  ><a href="#">{{ 'notificationsPage.popovers.bottomTooltip' | translate }}</a></vuestic-tooltip
                >
                the item.
              </p>
            </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget :header-text="'notificationsPage.alerts.title' | translate">
          <vuestic-alert type="success" :with-close-btn="true">
          ...
          <vuestic-alert type="info" :with-close-btn="true">
          ...
          <vuestic-alert type="warning" :with-close-btn="true">
          ...
          <vuestic-alert type="danger" :with-close-btn="true">
    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget :header-text="'notificationsPage.toasts.title' | translate">
          <div class="row">
            <div class="col-md-6">
              <fieldset>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <label class="control-label" for="toast-text">{{
                      'notificationsPage.toasts.textLabel' | translate
                    }}</label
                    ><i class="bar"></i>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    <input id="toast-duration" v-model="toastDuration" type="number" required />
                    <label class="control-label" for="toast-duration">{{
                      'notificationsPage.toasts.durationLabel' | translate
                    }}</label
                    ><i class="bar"></i>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <label class="control-label" for="toast-icon">{{
                      'notificationsPage.toasts.iconLabel' | translate
                    }}</label
                    ><i class="bar"></i>
                  </div>
                </div>
            ...
            <div class="col-md-6 justify-content-center align-items-center d-none d-md-flex">
              <div v-if="isToastContentPresent" class="toasted-container sample-toasted-container">
                <div class="toasted vuestic-toast none default">
                  <i v-if="toastIcon" class="fa" :class="toastIcon"></i>{{ toastText }}
                </div>
              </div>
            </div>
          </div>
