<template>
  <div class="sets-list row">
    <div class="col-md-12">
      <vuestic-widget :header-text="$t('icons.title')">
        <div class="row">
          <div v-for="(set, index) in sets" :key="index" class="small-set col-lg-6">
            <div class="set-content">
              ...
              <div>
                <template v-for="(filteredList, index) in set.filteredLists">
                  <div v-if="filteredList.length !== 2" :key="index" class="row">
                    <div v-for="(icon, index) in filteredList" :key="index" class="col-sm-2">
