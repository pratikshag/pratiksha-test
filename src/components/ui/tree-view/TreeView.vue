    ...
    <div class="col-md-12">
      <div class="row">
        <div class="small-set col-lg-6">
          <vuestic-widget :header-text="$t('treeView.basic')">
            <tree-view-basic-preview />
          </vuestic-widget>
        </div>

        <div class="small-set col-lg-6">
          <vuestic-widget :header-text="$t('treeView.icons')">
            <tree-view-icons-preview />
          </vuestic-widget>
        </div>

        <div class="small-set col-lg-6">
          <vuestic-widget :header-text="$t('treeView.advanced')">
            <tree-view-advanced-preview />
          </vuestic-widget>
        </div>

        <div class="small-set col-lg-6">
          <vuestic-widget :header-text="$t('treeView.editable')">
            <tree-view-editable-preview />
          </vuestic-widget>
        </div>

        <div class="small-set col-lg-6">
          <vuestic-widget :header-text="$t('treeView.selectable')">
