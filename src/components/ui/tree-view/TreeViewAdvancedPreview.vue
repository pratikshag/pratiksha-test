  ...
  <div class="tree-view-advanced-preview">
    <div class="row mb-4">
      <div class="small-set col-sm-6 d-flex justify-content-center">
        <button class="btn btn-primary btn-micro" @click="$refs.treeView.expand()">EXPAND ALL</button>
      </div>
      <div class="small-set col-sm-6 d-flex justify-content-center">
        <button class="btn btn-primary btn-micro" @click="$refs.treeView.collapse()">COLLAPSE ALL</button>
      </div>
    </div>
    ...
    <vuestic-tree-root ref="treeView">
      ...
      <vuestic-tree-category is-open label="Products">
