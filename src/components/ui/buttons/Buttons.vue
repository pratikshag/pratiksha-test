<template>
  <div class="buttons-page">
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget class="primary-secondary-buttons larger-padding" :header-text="$t('buttons.main')">
      ...
      <div class="col-md-12">
        <vuestic-widget class="color-buttons" :header-text="$t('buttons.advanced')">
          <div class="row">
            <div class="col-sm-6 col-lg-6 col-xl-3 d-flex justify-content-center">
            ...
            <div
              ...
              :class="{
                'col-lg-6 col-xl-4': sidebarOpened,
                'col-lg-4': !sidebarOpened,
              }"
            >
            ...
            <div
              class="col-sm-6 col-lg-6 col-xl-3 d-flex justify-content-center"
              :class="{
                'col-lg-6 col-xl-2': sidebarOpened,
                'col-lg-2': !sidebarOpened,
              }"
            >
      ...
      <div class="col-md-12">
        <vuestic-widget class="color-buttons" :header-text="$t('buttons.colors')">
          <div class="row btn-margin-row">
            <div class="col-sm-6 col-lg-6 col-xl-3 d-flex justify-content-center">
