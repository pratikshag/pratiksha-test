<template>
  <div class="ui-grid row">
    <div class="col-md-12">
      <vuestic-widget header-text="Fixed Grid">
        <div class="row">
    ...
    <div class="col-md-12">
      <vuestic-widget header-text="Desktop Grid">
        <div class="row">
        ...
        <div class="row">
          <div v-for="i in 6" :key="i" class="col-md-2">
            <div>.col-md-2</div>
          </div>
        </div>
        <div class="row">
          <div v-for="i in 12" :key="i" class="col-md-1">
            <div>.col-md-1</div>
          </div>
        </div>
      </vuestic-widget>
    ...
    <div class="col-md-12">
      <vuestic-widget header-text="Mobile and Desktop Grid">
        <div class="row">
    ...
    <div class="col-md-12">
      <vuestic-widget header-text="Offsets">
        <div class="row">
