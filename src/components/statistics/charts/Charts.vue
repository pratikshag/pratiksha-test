<template>
  <div class="charts-page">
    <div class="row">
      <div class="col-md-6">
        <vuestic-widget class="chart-widget" :header-text="$t('charts.verticalBarChart')">
          <vuestic-chart :data="verticalBarChartData" type="vertical-bar" />
        </vuestic-widget>
      </div>
      <div class="col-md-6">
        <vuestic-widget class="chart-widget" :header-text="$t('charts.horizontalBarChart')">
    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget class="chart-widget" :header-text="$t('charts.lineChart')">
    ...
    <div class="row">
      <div class="col-md-6">
        <vuestic-widget class="chart-widget" :header-text="$t('charts.pieChart')">
          <vuestic-chart :data="pieChartData" type="pie" />
        </vuestic-widget>
      </div>
      <div class="col-md-6">
        <vuestic-widget class="chart-widget" :header-text="$t('charts.donutChart')">
    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget class="chart-widget" :header-text="$t('charts.bubbleChart')">
