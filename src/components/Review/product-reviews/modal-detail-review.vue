        ...
        <div class="review-content">
          ...
          <div class="mt-4">
            ...
            <ul class="list list-inline card__review-list-text">
              <li class="card__review-text">
                Created Date <br />
                <span class="card__review-text--primary">{{ dateFormat_Ymd(reviewData.created_at) }}</span>
              </li>
              <li class="card__review-text">
                Edit Date <br />
                <span class="card__review-text--primary">{{
                  reviewData.edited_at ? dateFormat_Ymd(reviewData.edited_at) : '-'
                }}</span>
              </li>
            </ul>
          </div>
          ...
          <div style="text-align: left">
            User Image <br />
            <template v-if="reviewData.review.images.length">
              <ul class="list list-inline list-review-images">
            ...
            <template v-else>
              <span class="card__review-text--primary">No</span>
            </template>
          </div>
        </div>
      </div>
    ...
    productCounterReviewRating() {
      if (
        ...
        (this.$store.state.modal.reviewData.review.product.counter_review_rating ||
          this.$store.state.modal.reviewData.average_rating)
      ) {
        const rating =
          this.$store.state.modal.reviewData.review.product.counter_review_rating ||
