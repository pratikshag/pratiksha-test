  ...
  <div>
    <div class="row">
      <div class="col-xs-12 col-md-12">
        <vuestic-widget :header-text="$t('tables.basic')">
    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget :header-text="$t('tables.styled')">
          <div class="table-responsive">
    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget :header-text="$t('tables.advanced')">
          <vuestic-data-table
            :api-url="apiUrl"
            :table-fields="tableFields"
            :items-per-page="itemsPerPage"
            :default-per-page="defaultTablePerPage"
