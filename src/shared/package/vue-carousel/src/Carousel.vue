...
export default {
  ...
  computed: {
    ...
    maxOffset() {
      ...
      if (this.perPage === 1) {
        ...
        // return (this.carouselWidth * this.pageCount) - ((this.slideCount / this.perPage) * this.slideWidth);
        if ((this.slideCount / this.perPage) % 1 == 0) {
          return this.slideWidth * this.slideCount
        } else {
          return (this.slideWidth * this.slideCount) - this.carouselWidth
        }
      }
  ...
  methods: {
    ...
    goToPage(page) {
      ...
      // console.log(this.slideWidth * this.currentPerPage * page)
      ...
      if (this.perPage === 1) {
        ...
        // console.log((this.slideWidth * this.slideCount) - this.slideWidth)
        // return (this.carouselWidth * this.pageCount) - ((this.slideCount / this.perPage) * this.slideWidth);
      }
      // console.log(this.slideWidth * this.currentPerPage * page)
      // console.log(this.maxOffset)
  ...
  destroyed() {
    ...
    //   console.log(window);
    //   console.log(this.$refs["VueCarousel-wrapper"])
    //   window.removeEventListener("resize", this.getBrowserWidth);
    //   document.getElementById('VueCarousel-wrapper').removeEventListener(
    //     this.isTouch ? "touchstart" : "mousedown",
    //     this.onStart
    //   );
    // }
