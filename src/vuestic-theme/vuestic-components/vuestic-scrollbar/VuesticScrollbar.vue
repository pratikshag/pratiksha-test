<template>
    <div class="vuestic-scrollbar" ref="vuesticScrollbar">
        <div class="scrollbar-wrapper" ref="scrollbarWrapper">
            <div @touchend="stopDrag" @touchmove="onDrag"
    ...
    export default {
        ...
        methods: {
            ...
            onContentResize() {
                ...
                this.content.style.transition = 'margin-top .1s linear'
                this.thumb.style.transition = 'top .1s linear'
                let handler = (e) => {
        ...
        .scrollbar-wrapper {
            ...
            .track {
                ...
                .thumb {
                    ...
                    background-color: #f09ab9; // Scrollbar background
                    opacity: 0;
                    border-radius: 20px;
